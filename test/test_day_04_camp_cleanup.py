...
from src.day_04_camp_cleanup import number_of_containing_overlaps, number_of_overlaps
...
class Test(TestCase):
    ...
    def test_number_of_overlaps_example(self):
        input_data = [
            "2-4,6-8",
            "2-3,4-5",
            "5-7,7-9",
        ...
        actual = number_of_overlaps(input_data)
        self.assertEqual(4, actual)

    def test_number_of_overlaps_actual(self):
        input_data = lines_from_file("day04.txt")
        actual = number_of_overlaps(input_data)
        self.assertEqual(921, actual)
